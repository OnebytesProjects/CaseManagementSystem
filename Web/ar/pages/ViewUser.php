...
include "../connection/connection.php"; // Using database connection file here
  ...
  {	
      $old_pic = "../assets/images/profilepic/".$userdetails["photo"];
      
      $lawyer_photo = $_FILES["updateimage"]["name"];
      $tempname = $_FILES["updateimage"]["tmp_name"];	
      $folder = "../assets/images/profilepic/";
      $temp = explode(".", $_FILES["updateimage"]["name"]);
      $newfilename = $_POST['lawyer_email'] . '.' . end($temp);
      ...
      if($lawyer_photo == ''){
            ...
            <META HTTP-EQUIV="Refresh" CONTENT="0;URL=http://localhost/project/ar/pages/User.php">
            <?php
      }else{
            $update = " UPDATE user SET name ='".$_POST['lawyer_name']."',gender='".$_POST['lawyer_gender']."', mobile='".$_POST['lawyer_number']."', dob='".$_POST['lawyer_dob']."', email='".$_POST['lawyer_email']."',sector='".$_POST['lawyer_sector']."',auth_level='".$_POST['authorization_level']."',password='".$_POST['lawyer_password']."',photo='$newfilename' WHERE email ='$data';";
            if (mysqli_query($db, $update)) {
                //delete image
                if(!unlink($old_pic)){}else{}
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="file" id="myFile" name="updateimage" value="<?php echo $userdetails["photo"];?>">
                        </td>
                        <td></td>
                        <td></td>
                    </tr>
